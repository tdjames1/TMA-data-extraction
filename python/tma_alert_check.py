...
African Swift Project. This script allows manual checking and
correction of alerts generated by the PDF processing routine.
   :copyright: © 2020 University of Leeds.
   :license: BSD 3-clause (see LICENSE)
Example:
    To use::
        ./tma_alert_check.py <nc_dir>
        <input_dir> - Directory containing netcdf files to be checked
